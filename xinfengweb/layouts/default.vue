  ...
  <el-container>
    <el-header>
      <el-menu :default-active="activeIndex" mode="horizontal" router>
        ...
        <el-menu-item index="/tab/creative">解决方案</el-menu-item>
        <el-menu-item index="/tab/play">成功案例</el-menu-item>
        <el-menu-item index="/tab/apple">营销服务</el-menu-item>
        <el-menu-item index="/tab/play">人才招聘</el-menu-item>
      ...
      <footer>
          <div>
              <div class="footerList">
                  <div class="footerListTitle"><a href="">新闻动态</a></div>
                  <span><a href="">公司新闻</a></span>
                  <span><a href="">行业资讯</a></span>
                  <span><a href="">展会信息</a></span>
              </div>
              <div class="footerList">
                  <div class="footerListTitle"><a href="">产品中心</a></div>
                  <span><a href="">水联网产品</a></span>
                  <span><a href="">气联网系列</a></span>
                  <span></span>
              </div>
              <div class="footerList">
                  <div class="footerListTitle"><a href="">解决方案</a></div>
                  <span><a href="">智慧城市水系统</a></span>
                  <span><a href="">成功案例</a></span>
                  <span></span>
              </div>
              <div class="footerList">
                  <div class="footerListTitle"><a href="">营销与服务</a></div>
                  <span><a href="">服务政策</a></span>
                  <span><a href="">下载中心</a></span>
                  <span><a href="">问题反馈</a></span>
              </div>
              <div class="footerList">
                  <div class="footerListTitle"><a href="">关于我们</a></div>
                  <span><a href="">公司信息</a></span>
                  <span><a href="">资质荣耀</a></span>
